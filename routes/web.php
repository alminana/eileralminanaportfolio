...
use App\Http\Controllers\AdminControllers\AdminInformationController;
...
Route::post('/contact', [HomeController::class, 'store'])->name('home');
...
Route::name('admin.')->prefix('admin')->middleware(['auth', 'check_permissions'])->group(function(){
    ...
    // Route::post('information/store', [AdminInformationController::class, 'store'])->name('information.store');
    // Route::get('information/edit', [AdminInformationController::class, 'edit'])->name('information.edit');
    // Route::get('information/update/{$id}', [AdminInformationController::class, 'update'])->name('information.update');
    Route::resource('information', AdminInformationController::class);
    // Route::delete('information/{id}', [AdminInformationController::class, 'destroy'])->name('information.destroy');
});
