...
<div class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ route('admin.information.index') }}"><i class="bx bx-right-arrow-alt"></i>All Information</a>
                        </li>
                        <li> <a href="{{ route('admin.information.create') }}"><i class="bx bx-right-arrow-alt"></i>Add New Information</a>
                        </li>
