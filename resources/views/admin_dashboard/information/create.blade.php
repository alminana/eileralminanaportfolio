                                ...
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value='' name='slogan' required class="form-control" id="inputProductTitle">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value='' name='position' required class="form-control" id="inputProductTitle">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value='' name='address' required class="form-control" id="inputProductTitle">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" value='{{ old("mobile") }}' class="form-control" required name='mobile' id="inputProductTitle">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" value='' name='email' required class="form-control" id="inputProductTitle">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value='' name='website' required class="form-control" id="inputProductTitle">
